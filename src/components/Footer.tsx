        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              Platform pembelajaran bahasa modern yang menggabungkan teknologi
              AI dengan metode pembelajaran yang terbukti efektif untuk
              memberikan pengalaman belajar yang unik dan personal.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex justify-center">
            <span className="text-sm text-gray-400">
              &copy; 2024 LinguaShow. All rights reserved.
            </span>
          </div>
        </div>
      </div>
